...
bool DemoInit( void )
{
	g_glApp.Init( 10, 10, g_iScreenWidth, g_iScreenHeight, 16, "Demo 8_5: Fractal Cloud Generation", IDI_ICON1, IDR_MENU1 );
	...
	g_skydome.GenCloudTexture( 256, 0.5f, 25, 1.0f, 0.25f, 0.25f );

	//set the camera's position
	g_camera.SetPosition( 128.0f, 300.0f, 256.0f );

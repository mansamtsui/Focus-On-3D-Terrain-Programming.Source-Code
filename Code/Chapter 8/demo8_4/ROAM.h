...
class CROAM : public CTERRAIN
{
	...
	//--------------------------------------------------------------
	// Name:		 CROAM::SetMaxTrisPerFrame - public
	// Description:	 Set the allowed number of triangles ROAM can use per frame
	// Arguments:	 -iNumTris: max number of triangles
	// Return Value: None
	//--------------------------------------------------------------
	void SetMaxTrisPerFrame( int iNumTris )
	{	m_iMaxTris= iNumTris;	}

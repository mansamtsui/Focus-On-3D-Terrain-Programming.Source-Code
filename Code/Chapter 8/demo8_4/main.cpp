...
bool DemoInit( void )
{
	g_glApp.Init( 10, 10, g_iScreenWidth, g_iScreenHeight, 16, "Demo 8_4: Life in the Skydome", IDI_ICON1, IDR_MENU1 );
	...
	g_skydome.LoadTexture( "../Data/clouds.tga" );

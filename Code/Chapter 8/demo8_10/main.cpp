...
bool DemoInit( void )
{
	...
	g_glApp.Init( 10, 10, g_iScreenWidth, g_iScreenHeight, 16, "Demo 8_10: Making More Realistic Particles", IDI_ICON1, IDR_MENU1 );
	...
	g_particleEngine.SetSize( 0.5f, 0.5f );

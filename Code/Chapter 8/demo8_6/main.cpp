...
bool DemoInit( void )
{
	g_glApp.Init( 10, 10, g_iScreenWidth, g_iScreenHeight, 16, "Demo 8_6: Camera-Terrain Collision Detection and Simple Response", IDI_ICON1, IDR_MENU1 );

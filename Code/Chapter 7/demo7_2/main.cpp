...
bool DemoInit( void )
{
	...
	g_glApp.Init( 10, 10, g_iScreenWidth, g_iScreenHeight, 16, "Demo 7_2: ROAM Frustum Culling", IDI_ICON1, IDR_MENU1 );
	...
	g_ROAM.GenerateTextureMap( 1024 );
	...
	g_camera.SetPosition( 128.0f, 512.0f, 512.0f );
...
void DemoRender( void )
{
	...
	g_glApp.BeginTextMode( );
		...
		g_glApp.Print( 0, g_iScreenHeight-110, CVECTOR( 1.0f, 0.0f, 0.0f ), "Level: %d", g_iLevel );
	g_glApp.EndTextMode( );

...
bool DemoInit( void )
{
	...
	g_glApp.Init( 10, 10, g_iScreenWidth, g_iScreenHeight, 16, "Demo 7_3: Adding the Diamond Backbone Structure", IDI_ICON1, IDR_MENU1 );
	...
	//initialize the ROAM system
	g_ROAM.Init( g_iLevel, 32768, &g_camera );

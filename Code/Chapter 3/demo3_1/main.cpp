...
bool DemoInit( void )
{
	...
	g_glApp.Init( 10, 10, g_iScreenWidth, g_iScreenHeight, 16, "Demo 3_1: Simple Texture Mapping", IDI_ICON1, IDR_MENU1 );
	...
	g_bruteForce.MakeTerrainPlasma( 128, 1.0f );//默认先用断层算法
	g_bruteForce.SetHeightScale( 0.25f );

	//load the terrain texture in
	g_bruteForce.LoadTexture( "../Data/grass_1.tga" );

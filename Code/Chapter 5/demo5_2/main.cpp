...
bool DemoInit( void )
{
	...
	g_glApp.Init( 10, 10, g_iScreenWidth, g_iScreenHeight, 16, "Demo 5_2: Culling a Patch or Two", IDI_ICON1, IDR_MENU1 );
...
void DemoRender( void )
{
	...
	glPushMatrix( );
		g_geomipmapping.Scale( 8.0f, 5.0f, 8.0f );

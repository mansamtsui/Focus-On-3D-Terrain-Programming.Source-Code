...
bool DemoInit( void )
{
	...
	g_glApp.Init( 10, 10, g_iScreenWidth, g_iScreenHeight, 16, "Demo 6_3: Adding Frustum Culling", IDI_ICON1, IDR_MENU1 );
...
bool DemoInput( void )
{
	...
	{
		g_fDetailLevel+= 0.25f;

		if( g_fDetailLevel>100.0f )
			g_fDetailLevel= 100.0f;
	}

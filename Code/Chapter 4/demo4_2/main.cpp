...
bool DemoInit( void )
{
	...
	g_glApp.Init( 10, 10, g_iScreenWidth, g_iScreenHeight, 16, "Demo 4_2: Using a Lightmap", IDI_ICON1, IDR_MENU1 );
	...
	g_bruteForce.SetLightingType( LIGHTMAP );
	g_bruteForce.LoadLightMap( "lightmap.raw", 128 );
